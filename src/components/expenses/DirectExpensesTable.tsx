...
const DirectExpenseInput = ({ categoryId, initialValue, onValueChange, hasChanges }: {
...
const DirectExpensesTable = ({
  selectedMonth, selectedYear, categories, expenseValues, tempExpenseValues,
  hasUnsavedChanges, newCategoryName, showAddCategory,
  onUpdateExpense, onSaveExpenseValues, onAddNewCategory, onRemoveCategory,
  onEditCategory, onSetNewCategoryName, onSetShowAddCategory,
  getTempExpenseValue, calculateMonthTotal,
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ background: '#0f0f18', borderBottom: '1px solid #1e1e2a' }}>
                <th style={th}>Categoria de Despesa</th>
